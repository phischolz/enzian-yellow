...
class BasicEnzianYellow {
    ...
    async executeTaskByAddress(contractAddress, task, privateKey) {
        ...
        if (privateKey){
            ...
            try{
                ...
                console.log("ERROR IN ethereum/index_old.js, executeTaskByAddress->sendSignedTA, with pk given:", e.stack);
                return false;
            }
            ...
            try{
                ...
                console.log("ERROR IN ethereum/index_old.js, executeTaskByAddress->sendSignedTA, with NO pk given:",
                    e.stack);
                return false;
            }
        }
    ...
    async pkToAccount(pk){
        return this.web3Wrapper.web3.eth.accounts.privateKeyToAccount(pk);
    }
